                                            ...
                                            <div class="card-body">
                                                <div class="setting-card setting-logo-box">
                                                    <a href="{{ isset($setting['light_logo']) && checkFile($setting['light_logo']) ? getFile($setting['light_logo']) : getFile('uploads/logo/logo-light.png') . '?' . time() }}"
                                                        target="_blank" class="logo-content bg-dark">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <a href="{{ isset($setting['meta_image']) && checkFile($setting['meta_image']) ? getFile($setting['meta_image']) : getFile('uploads/metaevent/meta.jpg') . '?' . time() }}"
                                                    target="_blank">
                                                    <div class="logo-content">
                                                        <img src="{{ isset($setting['meta_image']) && checkFile($setting['meta_image']) ? getFile($setting['meta_image']) : getFile('uploads/metaevent/meta.jpg') . '?' . time() }}"
